  ...
  ys = (e, t, r, n) => {
    if ((t && typeof t == "object") || typeof t == "function")
      for (let o of _l(t))
        !Il.call(e, o) &&
          o !== r &&
          yr(e, o, { get: () => t[o], enumerable: !(n = Ol(t, o)) || n.enumerable })
    return e
  }
var ee = (e, t, r) => (
    (r = e != null ? Sl(Cl(e)) : {}),
    ys(t || !e || !e.__esModule ? yr(r, "default", { value: e, enumerable: !0 }) : r, e)
  ),
...
var Ns = K(($t) => {
  ...
  p()
  m()
  var vs = u((e, t) => () => (t || e((t = { exports: {} }).exports, t), t.exports), "q"),
    Dl = vs((e) => {
      "use strict"
      ...
      function f(x) {
        ...
        return (
          P === 2 &&
            ((h = (r[x.charCodeAt(R)] << 2) | (r[x.charCodeAt(R + 1)] >> 4)), (S[T++] = h & 255)),
          P === 1 &&
            ((h =
              (r[x.charCodeAt(R)] << 10) |
      ...
      function y(x, h, A) {
        for (var M, P = [], S = h; S < A; S += 3)
          (M = ((x[S] << 16) & 16711680) + ((x[S + 1] << 8) & 65280) + (x[S + 2] & 255)),
            P.push(g(M))
        return P.join("")
      }
      u(y, "wr")
  ...
  function Bl(e) {
    ...
    if (e.length !== void 0) return typeof e.length != "number" || Do(e.length) ? Ke(0) : _o(e)
  ...
  _.prototype.toString = function () {
    let e = this.length
    return e === 0 ? "" : arguments.length === 0 ? Ss(this, 0, e) : Ul.apply(this, arguments)
  }
  ...
  _.prototype.compare = function (e, t, r, n, o) {
    if ((Ve(e, Uint8Array) && (e = _.from(e, e.offset, e.byteLength)), !_.isBuffer(e)))
      throw new TypeError(
  ...
  function Wl(e, t, r) {
    return t === 0 && r === e.length ? Oo.fromByteArray(e) : Oo.fromByteArray(e.slice(t, r))
  }
  u(Wl, "Sr")
  function Ss(e, t, r) {
    ...
    for (; o < r; ) {
      ...
      if (o + a <= r) {
        ...
        switch (a) {
          ...
          case 2:
            ;(c = e[o + 1]),
              (c & 192) === 128 && ((g = ((i & 31) << 6) | (c & 63)), g > 127 && (s = g))
            break
          case 3:
            ;(c = e[o + 1]),
              (l = e[o + 2]),
  ...
  function Kl(e) {
    ...
    let r = "",
      n = 0
    for (; n < t; ) r += String.fromCharCode.apply(String, e.slice(n, (n += ws)))
    return r
  }
  u(Kl, "_r")
  function Ql(e, t, r) {
  ...
  _.prototype.readFloatLE = function (e, t) {
    return (e = e >>> 0), t || se(e, 4, this.length), kt.read(this, e, !0, 23, 4)
  }
  _.prototype.readFloatBE = function (e, t) {
    return (e = e >>> 0), t || se(e, 4, this.length), kt.read(this, e, !1, 23, 4)
  }
  _.prototype.readDoubleLE = function (e, t) {
    return (e = e >>> 0), t || se(e, 8, this.length), kt.read(this, e, !0, 52, 8)
  }
  _.prototype.readDoubleBE = function (e, t) {
    return (e = e >>> 0), t || se(e, 8, this.length), kt.read(this, e, !1, 52, 8)
  }
  ...
  _.prototype.writeBigInt64BE = st(function (e, t = 0) {
    return _s(this, e, t, -BigInt("0x8000000000000000"), BigInt("0x7fffffffffffffff"))
  })
    ...
    function (e, t, r) {
      ...
      return (
        Number.isInteger(r) && Math.abs(r) > 2 ** 32
          ...
          : typeof r == "bigint" &&
            ((o = String(r)),
            (r > BigInt(2) ** BigInt(32) || r < -(BigInt(2) ** BigInt(32))) && (o = xs(o)),
            (o += "n")),
  ...
  u(xs, "K")
  function ef(e, t, r) {
    jt(t, "offset"), (e[t] === void 0 || e[t + r] === void 0) && hr(t, e.length - (r + 1))
  }
  u(ef, "Dr")
  ...
  function hr(e, t, r) {
    throw Math.floor(e) !== e
      ...
      : new Nt.ERR_OUT_OF_RANGE(r || "offset", `>= ${r ? 1 : 0} and <= ${t}`, e)
  }
  u(hr, "T")
  var tf = /[^+/0-9A-Za-z-_]/g
  function rf(e) {
    if (((e = e.split("=")[0]), (e = e.trim().replace(tf, "")), e.length < 2)) return ""
    ...
    var i = {
      ...
      _compress: function (s, a, c) {
        ...
        for (R = 0; R < s.length; R += 1)
          if (
            ((b = s.charAt(R)),
            Object.prototype.hasOwnProperty.call(g, b) || ((g[b] = M++), (y[b] = !0)),
            (x = h + b),
...
var jo = K((Fy, Us) => {
  ...
  for (let e of Object.keys(N)) {
    if (!("channels" in N[e])) throw new Error("missing channels property: " + e)
    if (!("labels" in N[e])) throw new Error("missing channel labels property: " + e)
...
var Gs = K(($y, Vs) => {
  ...
  function mf(e, t) {
    let r = [t[e].parent, e],
      n = vn[t[e].parent][e],
      o = t[e].parent
    for (; t[o].parent; ) r.unshift(t[o].parent), (n = pf(vn[t[o].parent][o], n)), (o = t[o].parent)
...
`,
  ...
  function Pf(e, t) {
    ...
    for (let i of n) {
      ...
      else if ((o = i.match(Ef))) r.push(o[2].replace(Tf, (a, c, l) => (c ? na(c) : l)))
    ...
    if (
      (t.replace(vf, (i, s, a, c, l, f) => {
        if (s) o.push(na(s))
          ...
          let g = o.join("")
          ;(o = []), n.push(r.length === 0 ? g : ra(e, r)(g)), r.push({ inverse: a, styles: Mf(c) })
        } else if (l) {
...
var Mt = K((dh, fa) => {
  ...
  for (let e of ca) {
    ...
    Ut[t] = {
      get() {
        let { level: r } = this
        return function (...n) {
          let o = Go(wr.bgColor[aa[r]][e](...n), wr.bgColor.close, this._styler)
  ...
  var Cf = Object.defineProperties(() => {}, {
    ...
    Mn = u((e, t, r) => {
      ...
      return Object.setPrototypeOf(n, Cf), (n._generator = e), (n._styler = t), (n._isEmpty = r), n
    }, "createBuilder"),
    sa = u((e, t) => {
  ...
  var re = u((e, t) => () => (t || e((t = { exports: {} }).exports, t), t.exports), "p"),
    ...
    ii = re((e, t) => {
      ...
      var c = u(function () {
        ...
        x = {
          ...
          "%MapIteratorPrototype%": typeof Map > "u" || !f ? r : g(new Map()[Symbol.iterator]()),
          "%Math%": Math,
          "%Number%": Number,
          "%Object%": Object,
          ...
          "%SetIteratorPrototype%": typeof Set > "u" || !f ? r : g(new Set()[Symbol.iterator]()),
        ...
        h = u(function J(X) {
          ...
          else if (X === "%AsyncGeneratorFunction%") z = s("async function* () {}")
        ...
        te = u(function (J) {
          var X = R(J, 0, 1),
            z = R(J, -1)
          if (X === "%" && z !== "%") throw new n("invalid intrinsic syntax, expected closing `%`")
          if (z === "%" && X !== "%") throw new n("invalid intrinsic syntax, expected opening `%`")
          var H = []
          return (
        ...
        for (var Et = 1, qe = !0; Et < z.length; Et += 1) {
          ...
          if (
            ...
            if (a && Et + 1 >= z.length) {
              var Tt = a(ie, _e)
              ;(qe = !!Tt),
                qe && "get" in Tt && !("originalValue" in Tt.get) ? (ie = Tt.get) : (ie = ie[_e])
    ...
    Da = re((e, t) => {
      ...
      var r = kp(),
        ...
        a = u(function (l, f, g) {
          for (var y in l) o.call(l, y) && (g == null ? f(l[y], y, l) : f.call(g, l[y], y, l))
        }, "Wt"),
        c = u(function (l, f, g) {
    ...
    jp = re((e, t) => {
      ...
      var b = u(function (h) {
        ...
        x = ja()
      t.exports = function (h) {
        return x(h) ? (!s || !(Symbol.toStringTag in h) ? l(i(h), 8, -1) : b(h)) : !1
      }
    }),
    $p = re((e) => {
      "use strict"
      ...
      u(x, "N"), (e.isArgumentsObject = t), (e.isGeneratorFunction = r), (e.isTypedArray = o)
      function h(I) {
        return (
      ...
      function Et(I) {
        return typeof ArrayBuffer > "u" ? !1 : ot.working ? ot(I) : I instanceof ArrayBuffer
      }
      ...
      function _e(I) {
        return typeof DataView > "u" ? !1 : qe.working ? qe(I) : I instanceof DataView
      }
 ...
 `) +
  ...
  G.promisify = function (e) {
    ...
    if (Ot && e[Ot]) {
      ...
      return (
        Object.defineProperty(t, Ot, { value: t, enumerable: !1, writable: !1, configurable: !0 }),
        t
      )
    }
    function t() {
...
var ci = K((P0, za) => {
  ...
  function sm(e) {
    ...
    function t(f) {
      let g = 0
      for (let y = 0; y < f.length; y++) (g = (g << 5) - g + f.charCodeAt(y)), (g |= 0)
    ...
    function r(f) {
      ...
      return (
        ...
        Object.defineProperty(h, "enabled", {
          ...
          configurable: !1,
          get: () =>
            y !== null ? y : (b !== r.namespaces && ((b = r.namespaces), (x = r.enabled(f))), x),
          set: (A) => {
            y = A
          },
        }),
    ...
    function s(f) {
      ...
      let g, y
      for (g = 0, y = r.skips.length; g < y; g++) if (r.skips[g].test(f)) return !1
      for (g = 0, y = r.names.length; g < y; g++) if (r.names[g].test(f)) return !0
      return !1
    }
    u(s, "enabled")
    function a(f) {
...
`
  ...
  Ka.O = function (e) {
    return (this.inspectOpts.colors = this.useColors), Zn.inspect(e, this.inspectOpts)
  }
})
var Ya = K((V0, li) => {
  d()
...
var ku = K((tE, Nu) => {
  ...
  var tr = {
    resolve: function () {
      ...
      return (e = Du(e, !t)), t ? (e.length > 0 ? "/" + e : "/") : e.length > 0 ? e : "."
    },
    ...
    relative: function (e, t) {
      ...
      var b = ""
      for (f = r + l + 1; f <= n; ++f)
        (f === n || e.charCodeAt(f) === 47) && (b.length === 0 ? (b += "..") : (b += "/.."))
      return b.length > 0
        ? b + t.slice(i + l)
...
var $u = K((sE, Ti) => {
  ...
  function kr() {}
  u(kr, "_")
  Object.create && ((kr.prototype = Object.create(null)), new kr().__proto__ || (he = !1))
  function Km(e, t, r) {
  ...
  pe.prototype.removeListener = function (e, t, r, n) {
    ...
    if (i.fn) i.fn === t && (!n || i.once) && (!r || i.context === r) && lo(this, o)
    else {
...
var Yu = K((_S, Qu) => {
  ...
  u(we, "ArgError")
  function Qr(e, { argv: t = w.argv.slice(2), permissive: r = !1, stopAtPositional: n = !1 } = {}) {
    ...
    for (let a of Object.keys(e)) {
      ...
      if (Array.isArray(c) && c.length === 1 && typeof c[0] == "function") {
        let [f] = c
        ;(c = u((g, y, b = []) => (b.push(f(g, y, b[b.length - 1])), b), "type")),
          (l = f === Boolean || f[Di] === !0)
        ...
        for (let g = 0; g < f.length; g++) {
          ...
          if (!(h in s))
            if (r) {
              o._.push(y)
              continue
            } else throw new we(`unknown or unexpected option: ${b}`, "ARG_UNKNOWN_OPTION")
          let [A, M] = s[h]
          if (!M && g + 1 < f.length)
            throw new we(
...
var ac = K((Vi, Gi) => {
  ...
  m()
  ;(function (e, t) {
    typeof require == "function" && typeof Vi == "object" && typeof Gi == "object"
      ? (Gi.exports = t())
      : (e.pluralize = t())
  })(Vi, function () {
    var e = [],
    ...
    function f(b, x, h) {
      return function (A) {
        var M = A.toLowerCase()
        return x.hasOwnProperty(M) ? s(A, M) : b.hasOwnProperty(M) ? s(A, b[M]) : l(M, A, h)
      }
    }
    u(f, "replaceWord")
    function g(b, x, h, A) {
      return function (M) {
        var P = M.toLowerCase()
        return x.hasOwnProperty(P) ? !0 : b.hasOwnProperty(P) ? !1 : l(P, P, h) === P
      }
    }
    u(g, "checkWord")
    function y(b, x, h) {
...
C.inverseTangent = C.atan = function () {
  ...
  if (l.isFinite()) {
    ...
    if (l.abs().eq(1) && g + 4 <= Ho) return (s = Ne(f, g + 4, y).times(0.25)), (s.s = l.s), s
  } else {
    if (!l.s) return new f(NaN)
    if (g + 4 <= Ho) return (s = Ne(f, g + 4, y).times(0.5)), (s.s = l.s), s
  }
  for (f.precision = a = g + 10, f.rounding = 1, r = Math.min(28, (a / j + 2) | 0), e = r; e; --e)
  ...
  return r && (s = s.times(2 << (r - 1))), (L = !0), k(s, (f.precision = g), (f.rounding = y), !0)
}
C.isFinite = function () {
  return !!this.d
}
...
C.logarithm = C.log = function (e) {
  ...
  if (
    ...
    do
      if (
        ((a += 10), (s = ut(l, a)), (n = t ? In(f, a + 10) : ut(e, a)), (c = Y(s, n, a, 1)), !i)
      ) {
...
C.minus = C.sub = function (e) {
  ...
  if (((l = b.d), (y = e.d), (a = x.precision), (c = x.rounding), !l[0] || !y[0])) {
    if (y[0]) e.s = -e.s
  ...
  if (((r = le(e.e / j)), (f = le(b.e / j)), (l = l.slice()), (i = f - r), i)) {
    for (
      g = i < 0,
        g ? ((t = l), (i = -i), (s = y.length)) : ((t = y), (r = f), (s = l.length)),
  ...
  for (; l[--s] === 0; ) l.pop()
  for (; l[0] === 0; l.shift()) --r
  return l[0] ? ((e.d = l), (e.e = Fn(l, r)), L ? k(e, a, c) : e) : new x(c === 3 ? -0 : 0)
}
...
C.plus = C.add = function (e) {
  ...
  if (((l = g.d), (f = e.d), (a = y.precision), (c = y.rounding), !l[0] || !f[0]))
...
C.times = C.mul = function (e) {
  ...
  if (((e.s *= f.s), !y || !y[0] || !b || !b[0]))
    return new g(
      !e.s || (y && !y[0] && !b) || (b && !b[0] && !y) ? NaN : !y || !b ? e.s / 0 : e.s * 0
    )
  for (
    r = le(f.e / j) + le(e.e / j),
      c = y.length,
  ...
  for (; !i[--s]; ) i.pop()
  return t ? ++r : i.shift(), (e.d = i), (e.e = Fn(i, r)), L ? k(e, g.precision, g.rounding) : e
}
...
C.toDecimalPlaces = C.toDP = function (e, t) {
  ...
  return (
    ...
    e === void 0
      ? r
      : (ve(e, 0, lt), t === void 0 ? (t = n.rounding) : ve(t, 0, 8), k(r, e + r.e + 1, t))
  )
}
...
C.toFraction = function (e) {
  ...
  for (
    L = !1, a = new h(ae(x)), f = h.precision, h.precision = i = x.length * j * 2;
  ...
  return (
    ...
    (r = r.plus(o.times(n))),
    (c.s = l.s = b.s),
    (y = Y(l, n, i, 1).minus(b).abs().cmp(Y(c, r, i, 1).minus(b).abs()) < 1 ? [l, n] : [c, r]),
    (h.precision = f),
    (L = !0),
    y
  )
...
C.toNearest = function (e, t) {
  ...
  if (((r = new n(r)), e == null)) {
    ...
    if (((e = new n(e)), t === void 0 ? (t = n.rounding) : ve(t, 0, 8), !r.d)) return e.s ? r : e
    if (!e.d) return e.s && (e.s = r.s), e
  }
  return (
    e.d[0] ? ((L = !1), (r = Y(r, e, 0, t, 1).times(e)), (L = !0), k(r)) : ((e.s = r.s), (r = e)), r
  )
}
C.toNumber = function () {
  return +this
...
function ae(e) {
  var t,
    ...
    s = e[0]
  if (o > 0) {
    for (i += s, t = 1; t < o; t++) (n = e[t] + ""), (r = j - n.length), r && (i += at(r)), (i += n)
...
var Y = (function () {
  ...
  return (
    ...
    function (n, o, i, s, a, c) {
      ...
      for (
        c ? ((b = 1), (f = n.e - o.e)) : ((c = ke), (b = j), (f = le(n.e / b) - le(o.e / b))),
          V = $.length,
          W = H.length,
          M = new X(z),
          P = M.d = [],
      ...
      if (
        ...
        if (((R = (R / b + 2) | 0), (g = 0), V == 1)) {
          ...
          for (
            y = (c / ($[0] + 1)) | 0,
              y > 1 && (($ = e($, y, c)), (H = e(H, y, c)), (V = $.length), (W = H.length)),
              B = V,
              S = H.slice(0, V),
              T = S.length;
            T < V;
...
function k(e, t, r, n) {
  ...
  e: if (t != null) {
    ...
    if (((i = t - o), i < 0))
      (i += j), (s = t), (f = g[(y = 0)]), (c = (f / ne(10, o - s - 1)) % 10 | 0)
      ...
      ;(i %= j), (s = i - j + o), (c = s < 0 ? 0 : (f / ne(10, o - s - 1)) % 10 | 0)
    }
    if (
      ((n = n || t < 0 || g[y + 1] !== void 0 || (s < 0 ? f : f % ne(10, o - s - 1))),
      (l =
        r < 4
          ? (c || n) && (r == 0 || r == (e.s < 0 ? 3 : 2))
          : c > 5 ||
            (c == 5 &&
              (r == 4 ||
                n ||
                (r == 6 && (i > 0 ? (s > 0 ? f / ne(10, o - s) : 0) : g[y - 1]) % 10 & 1) ||
                r == (e.s < 0 ? 8 : 7)))),
      t < 1 || !g[0])
    )
      return (
        (g.length = 0),
        l
          ? ((t -= e.e + 1), (g[0] = ne(10, (j - (t % j)) % j)), (e.e = -t || 0))
          : (g[0] = e.e = 0),
        e
      )
    if (
  ...
  return (
    L && (e.e > b.maxE ? ((e.d = null), (e.e = NaN)) : e.e < b.minE && ((e.e = 0), (e.d = [0]))), e
  )
}
u(k, "finalise")
function Ge(e, t, r) {
  ...
  return (
    t
      ...
      : o >= s
      ? ((i += at(o + 1 - s)), r && (n = r - o - 1) > 0 && (i = i + "." + at(n)))
...
function va(e, t, r, n) {
  var o,
    ...
    s = Math.ceil(n / j + 4)
  for (L = !1; ; ) {
    if ((r % 2 && ((i = i.times(t)), ma(i.d, s) && (o = !0)), (r = le(r / 2)), r === 0)) {
...
function Wo(e, t) {
  ...
  for (t == null ? ((L = !1), (c = x)) : (c = t), a = new y(0.03125); e.e > -2; )
    (e = e.times(a)), (g += 5)
  for (
...
function ut(e, t) {
  ...
  for (g = h, c = s = h = Y(h.minus(1), h.plus(1), f, 1), y = k(h.times(h), f, 1), o = 3; ; ) {
    if (
      ((s = k(s.times(y), f, 1)),
...
function jf(e, t) {
  ...
  for (
    i = t.search(/p/i),
      ...
      s = i >= 0,
      n = e.constructor,
      s && ((t = t.replace(".", "")), (a = t.length), (i = a - i), (o = va(n, new n(r), i, i * 2))),
      l = On(t, r, ke),
      f = l.length - 1,
      i = f;
    l[i] === 0;
...
function Aa(e, t) {
  ...
  if (((r = t.divToInt(o)), r.isZero())) Qe = n ? 3 : 2
    ...
    if (((t = t.minus(r.times(o))), t.lte(i))) return (Qe = pa(r) ? (n ? 2 : 3) : n ? 4 : 1), t
    Qe = pa(r) ? (n ? 1 : 4) : n ? 3 : 2
  }
...
function Qo(e, t, r, n) {
  ...
  if (
    ...
    for (
      f = Ge(e),
        s = f.indexOf("."),
        x ? ((o = 2), t == 16 ? (r = r * 4 - 3) : t == 8 && (r = r * 3 - 2)) : (o = t),
        s >= 0 &&
          ((f = f.replace(".", "")),
          (y = new b(1)),
          (y.e = f.length - s),
...
function mp(e) {
  var t,
    ...
    s = new this(1),
    a = []
  if ((e === void 0 ? (e = this.precision) : ve(e, 1, lt), (n = Math.ceil(e / j)), this.crypto))
  ...
  for (
    n = a[--i], e %= j, n && e && ((o = ne(10, j - e)), (a[i] = ((n / o) | 0) * o));
    a[i] === 0;
    i--
  )
    a.pop()
...
function Sp(e, t) {
  ...
  if ((t == null ? void 0 : t.namespace) === "prisma" && Oa.includes(r.name)) {
    ...
    return typeof o == "string" && jn.instances[o] === e && r.values.includes(o)
  }
...
${(0, Xo.default)(e.values.join(", "), 2)}
}`
  {
    let r = (0, Xo.default)(
      e.fields.map((n) => {
        let o = `${n.name}`,
          i = `${t ? ft.default.green(o) : o}${n.isRequired ? "" : "?"}: ${ft.default.white(
            n.inputTypes.map((s) => Pr(Op(s.type) ? s.type.name : Ht(s.type), s.isList)).join(" | ")
          )}`
...
`),
    ...
    return `${ft.default.dim("type")} ${ft.default.bold.dim(e.name)} ${ft.default.dim("{")}
${r}
${ft.default.dim("}")}`
  }
}
    ...
    : n.fields.reduce((i, s) => {
        ...
        return (
          !o && !s.isRequired
            ...
            : (a = s.inputTypes.map((c) => ei(c.type, s.isRequired, !0)).join(" | ")),
...
function gt(e, t, r, n) {
  ...
  return (
    (i[e] = t), r.debug("@opentelemetry/api: Registered a global for " + e + " v" + dt + "."), !0
  )
}
u(gt, "registerGlobal")
function $e(e) {
  ...
  if (!(!n || !ru(n))) return (r = Rr[Ir]) === null || r === void 0 ? void 0 : r[e]
}
u($e, "getGlobal")
function yt(e, t) {
...
async function Wr(e, t) {
  ...
  let r = { clientVersion: t, response: e },
    n = await Xm(e)
  if (n.type === "QueryEngineError") throw new Ie(n.body.message, n.body.error_code, t)
...
async function sd(e) {
  ...
  throw new tt("Only `major.minor.patch` versions are supported by Prisma Data Proxy.", {
    clientVersion: r,
  })
}
...
var go = {},
  ...
  U = {
    ...
    disableWorkerMessageHandler: go.Prism && go.Prism.disableWorkerMessageHandler,
    util: {
      encode: function (e) {
        if (e instanceof Le) {
          let t = e
...
function Sd({ callsite: e, message: t, originalMethod: r, isPanic: n, callArguments: o }, i) {
  var g
  let s = {
...
var Ac = u((e) => (Array.isArray(e) ? e : e.split(".")), "keys"),
  ...
  yo = u(
    (e, t, r) =>
      Ac(t).reduceRight((n, o, i, s) => Object.assign({}, zi(e, s.slice(0, i)), { [o]: n }), r),
    "deepSet"
  )
d()
p()
...
p()
m()
var Rd = { "[object Date]": !0, "[object Uint8Array]": !0, "[object Decimal]": !0 }
function Mc(e) {
  return e ? typeof e == "object" && !Rd[Object.prototype.toString.call(e)] : !1
}
u(Mc, "isObject")
d()
p()
        ...
        let g =
          ...
          i
            .map((y, b) => {
              ...
              return s.transformValue && (h = s.transformValue(i, b, h)), l.indent + h + x
            })
            .join("") +
          l.pad +
          "]"
...
`),
          ...
          R && R.length > 0 && !B && T.splice(1, 0, i + R + W),
            R && R.length > 0 && B && T.splice(T.length - 1, 0, i.slice(0, i.length - 2) + W),
            (S = T.join(`
`))
        }
        return S
    ...
    constructor(t, r) {
      ...
      this.printFieldError = u(({ error: t }, r, n) => {
        if (t.type === "emptySelect") {
          ...
          return `The ${D.default.redBright("`select`")} statement for type ${D.default.bold(
        ...
        if (t.type === "emptyInclude") {
          ...
          let o = n ? "" : ` Available options are listed in ${D.default.greenBright.dim("green")}.`
          return `The ${D.default.redBright("`include`")} statement for type ${D.default.bold(
            St(t.field.outputType.type)
          )} must not be empty.${o}`
        }
        ...
        if (t.type === "includeAndSelect")
          return `Please ${D.default.bold("either")} use ${D.default.greenBright(
            "`include`"
...
This model has no relations, so you can't use ${D.default.redBright("include")} with it.`
            ...
            a = `${i} field ${D.default.redBright(`\`${t.providedName}\``)} for ${D.default.bold(
              o
            )} statement on model ${D.default.bold.white(t.modelName)}.${s}`
          return (
            t.didYouMean && (a += ` Did you mean ${D.default.greenBright(`\`${t.didYouMean}\``)}?`),
            t.isIncludeScalar &&
              (a += `
Note, that ${D.default.bold("include")} statements only accept relation fields.`),
        ...
        if (t.type === "invalidFieldType")
          return `Invalid value ${D.default.redBright(
            `${tn(t.providedValue)}`
          )} of type ${D.default.redBright(Wt(t.providedValue, void 0))} for field ${D.default.bold(
            `${t.fieldName}`
          )} on model ${D.default.bold.white(t.modelName)}. Expected either ${D.default.greenBright(
            "true"
          )} or ${D.default.greenBright("false")}.`
      }, "printFieldError")
      this.printArgError = u(({ error: t, path: r, id: n }, o, i) => {
        if (t.type === "invalidName") {
          let s = `Unknown arg ${D.default.redBright(`\`${t.providedName}\``)} in ${D.default.bold(
            r.join(".")
          )} for type ${D.default.bold(t.outputType ? t.outputType.name : Ar(t.originalType))}.`
          return (
            t.didYouMeanField
              ? (s += `
\u2192 Did you forget to wrap it with \`${D.default.greenBright("select")}\`? ${D.default.dim(
                  "e.g. " +
                    D.default.greenBright(`{ select: { ${t.providedName}: ${t.providedValue} } }`)
                )}`)
              : t.didYouMeanArg
...
`),
            ...
            return `Argument ${D.default.bold(t.argName)}: Provided value ${D.default.redBright(
              s
            )}${a ? "" : " "}of type ${D.default.redBright(
              Wt(t.providedValue)
            )} on ${D.default.bold(
              `prisma.${this.children[0].name}`
            )} is not a ${D.default.greenBright(
              Pr(Ht(t.requiredType.bestFittingType.type), t.requiredType.bestFittingType.isList)
            )}.
\u2192 Possible values: ${t.requiredType.bestFittingType.type.values
              .map((g) => D.default.greenBright(`${Ht(t.requiredType.bestFittingType.type)}.${g}`))
              .join(", ")}`
          let c = "."
...
` + Kt(t.requiredType.bestFittingType.type))
          let l = `${t.requiredType.inputType
              .map((g) =>
                D.default.greenBright(Pr(Ht(g.type), t.requiredType.bestFittingType.isList))
              )
              .join(" or ")}${c}`,
            f =
          ...
          return (
            f &&
              (l +=
                `
` + Kt(f.type, !0)),
            `Argument ${D.default.bold(t.argName)}: Got invalid value ${D.default.redBright(s)}${
              a ? "" : " "
            }on ${D.default.bold(
              `prisma.${this.children[0].name}`
            )}. Provided ${D.default.redBright(Wt(t.providedValue))}, expected ${l}`
          )
        }
        if (t.type === "invalidNullArg") {
          let s =
              r.length === 1 && r[0] === t.name ? "" : ` for ${D.default.bold(`${r.join(".")}`)}`,
            a = ` Please use ${D.default.bold.greenBright("undefined")} instead.`
          return `Argument ${D.default.greenBright(t.name)}${s} must not be ${D.default.bold(
            "null"
          )}.${a}`
        }
          ...
          let s = i ? "" : ` Available args are listed in ${D.default.dim.green("green")}.`,
            a = t.atLeastFields
              ? ` and at least one argument for ${t.atLeastFields
                  ...
                  .join(", or ")}`
              : ""
          return `Argument ${D.default.bold(r.join("."))} of type ${D.default.bold(
            t.inputType.name
          )} needs ${D.default.greenBright("at least one")} argument${D.default.bold(a)}.${s}`
        }
        if (t.type === "atMostOne") {
          let s = i
            ? ""
  ...
  rn
    ...
    validate(t, r = !1, n, o, i) {
      ...
      for (let P of s) {
        ...
        a.push(...S.fieldErrors.map((T) => ({ ...T, path: r ? T.path : T.path.slice(1) }))),
          c.push(...S.argErrors.map((T) => ({ ...T, path: r ? T.path : T.path.slice(1) })))
      }
      ...
      for (let P of a) {
        ...
        if (
          ...
          ;(M = P.error.field.outputType.type.fields) == null ||
            M.filter((F) =>
              P.error.type === "emptyInclude" ? F.outputType.location === "outputObjectTypes" : !0
            ).forEach((F) => {
      ...
      for (let P of c) {
        ...
        else if (P.error.type !== "missingArg" && P.error.type !== "atLeastOne") b.push(S)
      ...
      let h = u((P) => {
          let S = c.some((V) => V.error.type === "missingArg" && V.error.missingArg.isRequired),
            T = Boolean(
          ...
          S &&
            (R += `
${D.default.dim("Note: Lines with ")}${D.default.reset.greenBright("+")} ${D.default.dim(
              "are required"
            )}`),
            T &&
              (R.length === 0 &&
...
`),
              S
                ? (R += D.default.dim(`, lines with ${D.default.green("?")} are optional`))
                : (R += D.default.dim(`Note: Lines with ${D.default.green("?")} are optional`)),
              (R += D.default.dim(".")))
          let B = c
...
u(Fe, "Arg")
function vo({ dmmf: e, rootTypeName: t, rootField: r, select: n, modelName: o }) {
  n || (n = {})
...
function Nc(e, t, r, n, o) {
  ...
  return Object.entries(t).reduce((s, [a, c]) => {
    ...
    let f = {
      ...
      y = g ? xo(g, f, o, [], typeof l == "string" ? void 0 : l.outputType.type) : void 0,
...
function Ud(e, t, r = e.isList) {
  let n = Ht(e.type)
  return e.location === "fieldRefTypes" && t.modelName && (n += `<${t.modelName}>`), Pr(n, r)
}
  ...
  if ((o == null ? void 0 : o.hasError) && i.length > 0) {
    let s = i.map(({ arg: a, errors: c }) => {
      let l = c.map((f) => {
        let g = 1
        return (
          f.error.type === "invalidType" && (g = 2 * Math.exp(jc(f.error.providedValue)) + 1),
...
function zd(e, t, r, n, o) {
    ...
    if (pr(n.type)) {
        ...
        return Xi(e, t, r, n)
      {
        ...
        return (
          ...
          ((f = n.type.constraints.fields) == null ? void 0 : f.some((S) => M.includes(S))) === !1
            ? (A = {
                type: "atLeastOne",
                key: e,
                inputType: n.type,
            ...
            : P > 1 &&
              ...
              (A = { type: "atMostOne", key: e, inputType: n.type, providedKeys: M }),
          new Fe({
            key: e,
  ...
  let a = n.type,
    l = (
      typeof ((g = a.constraints) == null ? void 0 : g.minNumFields) == "number" &&
      ((y = a.constraints) == null ? void 0 : y.minNumFields) > 0
        ? Array.isArray(t) && t.some((h) => !h || Object.keys(wo(h)).length === 0)
        : !1
    )
  ...
  if (!l) {
    let h =
      typeof ((b = a.constraints) == null ? void 0 : b.maxNumFields) == "number" &&
      ((x = a.constraints) == null ? void 0 : x.maxNumFields) < 2
        ? Array.isArray(t) && t.find((A) => !A || Object.keys(wo(A)).length !== 1)
        : !1
  ...
  if (!Array.isArray(t))
    for (let h of r.inputTypes) {
      ...
      if (A.collectErrors().length === 0)
        return new Fe({ key: e, value: A, isEnum: !1, schemaArg: r, inputType: h })
    }
  return new Fe({
    key: e,
    value: t.map((h) =>
...
function xo(e, t, r, n, o) {
          ...
          b.push(
            new Fe({
              ...
              error: {
                ...
                providedValue: h,
                didYouMeanField: P,
                didYouMeanArg: (!P && Ln(x, [...s.map((S) => S.name), "select"])) || void 0,
                originalType: t,
                possibilities: n,
                outputType: o,
              },
  ...
  if (
    ...
    let b = t.fields.filter(
      (x) => !x.isRequired && i && (typeof i[x.name] == "undefined" || i[x.name] === null)
    )
    g.push(
      ...b.map((x) => {
...
function Wd({ ast: e, keyPaths: t, missingItems: r, valuePaths: n }) {
  let o = t.map(Yi),
    i = n.map(Yi),
    s = r.map((c) => ({ path: Yi(c.path), isRequired: c.isRequired, type: c.type }))
...
function an(e, t) {
  ...
  return new Proxy(e, {
    ...
    set(s, a, c) {
      ...
      let l = r.get(a)
      return ((g =
        (f = l == null ? void 0 : l.getPropertyDescriptor) == null ? void 0 : f.call(l, a)) == null
        ? void 0
        : g.writable) === !1
        ? !1
        : (o.add(a), i.set(s, a, c))
...
function os(e) {
  ...
  return Object.entries(t).reduce(
    (n, [o, i]) => (Lc[o] !== void 0 ? (n.select[o] = { select: i }) : (n[o] = i), n),
    { select: {} }
  )
}
...
function as(e, t) {
  var o
  let r = [vg(e, t)]
  ;(o = e._engineConfig.previewFeatures) != null && o.includes("fieldReference") && r.push(Ag(e, t))
  let n = ln(t)
...
function Eg(e, t) {
  let r = Object.keys(e._baseDmmf.mappingsMap[t]).filter((o) => o !== "model" && o !== "plural")
  r.push("count")
...
function Wc(e) {
  if (!this._hasPreviewFlag("clientExtensions")) throw new ge("Extensions are not yet available")
  let t = Hc(this),
    r = Object.create(t, {
      _extensions: {
        get: () =>
      ...
      (this.dataloader = new mn({
        batchLoader: (n) => {
          ...
          let o = Xc(n[0]),
            ...
            s = rr({ context: n[0].otelParentCtx, tracingConfig: t._tracingConfig })
          s && (o.headers.traceparent = s)
          let a =
            ((c = o.transaction) == null ? void 0 : c.kind) === "batch" ? o.transaction : void 0
        ...
        singleLoader: (n) => {
          ...
          let o = Xc(n),
            i = String(n.document),
            s = ((a = o.transaction) == null ? void 0 : a.kind) === "itx" ? o.transaction : void 0
    ...
    try {
      ...
      if (l) {
        let S = await l({ document: t, runInTransaction: Boolean(y) }, (T) =>
          this.dataloader.request({ ...T, tracingConfig: this.client._tracingConfig })
        )
...
function Sg(e) {
  ...
  let t =
      (n = e.document.children[0].args) == null
        ...
        : n.args
            .map((o) =>
              o.value instanceof de ? `${o.key}-${o.value.args.map((i) => i.key).join(",")}` : o.key
            )
            .join(","),
...
function _g(e, t) {
  return typeof e == "bigint"
    ...
    ? { prisma__type: "bytes", prisma__value: v.Buffer.from(e).toString("base64") }
...
It should have this form: { url: "CONNECTION_STRING" }`)
    ...
    rejectOnNotFound: (e) => {
      if (!!e) {
        if (Yr(e) || typeof e == "boolean" || typeof e == "object" || typeof e == "function")
          return e
        throw new oe(
...
function dl(e) {
  class t {
    constructor(n) {
      ...
      try {
        ...
        if (
          ((this._engineConfig = {
            ...
            logQueries:
              ...
              Boolean(
                typeof h.log == "string"
                  ? h.log === "query"
                  : h.log.find((F) => (typeof F == "string" ? F === "query" : F.level === "query"))
              ),
            env:
              (x =
          ...
          ye("clientEngineType", this._dataProxy ? "dataproxy" : this._clientEngineType),
    ...
    $executeRawInternal(n, o, i, ...s) {
      ...
      if (typeof i == "string")
        ...
        switch (this._activeProvider) {
          ...
          case "mysql": {
            let f = new ce(i, s)
            ;(a = f.sql), (c = { values: Be(f.values), __prismaRawParameters__: !0 })
            break
          }
          case "cockroachdb":
          case "postgresql": {
    ...
    async $queryRawInternal(n, o, i, ...s) {
      let a = "",
        c
      if (typeof i == "string") (a = i), (c = { values: Be(s || []), __prismaRawParameters__: !0 })
      else if (ml(i))
        switch (this._activeProvider) {
          case "sqlite":
          case "mysql": {
          ...
          case "postgresql": {
            let f = new ce(i, s)
            ;(a = f.text), (c = { values: Be(f.values), __prismaRawParameters__: !0 })
            break
          }
          case "sqlserver": {
            let f = new ce(i, s)
            ;(a = gn(f.strings)), (c = { values: Be(f.values), __prismaRawParameters__: !0 })
            break
          }
          default:
  ...
  __internal: {
      ...
      try {
        let o = {
          ...
          a = u((c) => {
            ...
            if (l) return nr(i.middleware, async (b) => l(c, (x) => (b == null || b.end(), a(x))))
    ...
    async _executeRequest({
      ...
      if (Je.enabled("prisma:client")) {
        let V = String(B)
        ye("Prisma Client call:"),
          ye(`prisma.${o}(${ho({ ast: n, keyPaths: [], valuePaths: [], missingItems: [] })})`),
